...
<html>
    <head>
        ...
        <script src="/painelCopa/js/jquery-1.7.2.min.js" type="text/javascript"></script>    
        <script src="/painelCopa/js/opentip-jquery.js" type="text/javascript"></script>
        <script type="text/javascript" src="/painelCopa/js/d3.v3.min.js"></script>
        <link href="/painelCopa/css/opentip.css" rel="stylesheet" type="text/css" />
        ...
        <script src="/painelCopa/js/jq-ui.min.js"></script>
        <link href="/painelCopa/css/jq-ui.css" rel="stylesheet" type="text/css" /> 
   ...
   <body>
        <div class="container" id="container" style="min-height: 1285px;">     
            ...
            <div class="conteinerPainelCopa ">
                <div class="headerPainel">
                    ...
                    <a href="#1" onclick="javascript: openModalInfo();">
                        ...
                        <img src="/painelCopa/images/icon_info_agenda.png">
                    </a>
                </div>
                ...
                <div class="mapWrapper">
                    ...
                    <div class="legend">
                        <div class="greenLegend">
                            <p>Possui Cidade-Sede</p>
                        </div>
                        <div class="grayLegend">
                            <p>Não possui Cidade-Sede</p>
                        </div>
                    </div>
                </div>
                <div class="pie" > 
                ...
                <div class="msg" id="msg">
                    ...
                    <p>Para selecionar mais de um empreendimento segure o botão Ctrl e clique nos empreendimentos desejados.</p>
                </div>
                <div class="EmpTable" id='EmpTable'> </div>
                <div class="columnChart" id="columnChart">
                    <p>Selecione um empreendimento para visualização.</p>
                </div>
            ...
            <script type='text/javascript'>
                        ...
                        dataMap = {
                            estados: [
                                ...
                                ,
                                {path: "pathDF", texto: "Brasília", id: "2"}
                                ,
                                {path: "pathPE", texto: "Recife", id: "9"}
                                ,
                                {path: "pathSP", texto: "São Paulo", id: "12"}
                                ,
                        ...
                        function reloadPieChart(e, m) {
                            ...
                            $.getJSON('/painelCopa/ServletSedeTema?SEDE=' + e, function(json) {
                                dataJson = json;
                            });
                        ...
                        function loadTable(idTema, m) {
                            ...
                            if (idTema == "" || idTema === null) {
                                $.getJSON('/painelCopa/ServletTemaEmp?SEDE=' + idSede, function(json) {
                                    EmpJson = json;
                                });
                            } else {

                                $.getJSON('/painelCopa/ServletTemaEmp?SEDE=' + idSede + '&TEMA=' + idTema, function(json) {
                                    EmpJson = json;
                                });
                            }
            ...
            <div id="modalInfo" class="modalInfo" title="Informação do Painel da Copa 2014">
                <p>O objetivo do painel é apresentar de forma gráfica e interativa os investimentos nos empreendimentos de cada cidade-sede dos jogos da copa.</p>

                <p>O painel permite analisar o percentual dos investimentos por tema de atuação e os recursos previsto e contratado na realização de cada empreendimento.</p>

                <p>O Painel Copa 2014 foi desenvolvido pela COPPE/UFRJ em parceria com a UNIFEI (Universidade Federal de Itajubá) e o Ministério do Planejamento, Orçamento e Gestão.</p>
                ...
                <ul>
                    ...
                    <li>Para a elaboração do Gráfico de Pizza e do Gráfico de Colunas foi utilizado a tecnologia Highcharts</li>

                    <li>A Tabela foi gerada com a tecnologia Google Visualization API</li>
                </ul>

                <p>Os dados apresentados estão disponíveis para download no site Copa 2014 - Transparência em 1º lugar, através do link abaixo:</p>
